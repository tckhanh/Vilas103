<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Pages/Root.master" CodeBehind="EquType.aspx.cs" Inherits="vilas103.EquType" Title="EquType" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Head">
    ...
    <script type="text/javascript" src='<%# ResolveUrl("~/Content/Scripts/EquType.js") %>'></script>
</asp:Content>
...
<asp:Content runat="server" ContentPlaceHolderID="PageToolbar">
    <dx:ASPxMenu runat="server" ID="PageToolbar" ClientInstanceName="pageToolbar"
        ...
        <Items>
            <dx:MenuItem Enabled="false" Text="LOẠI SẢN PHẨM">
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    <dx:ASPxGridView runat="server" ID="GridView" ClientInstanceName="gridView"
        ...
        <EditFormLayoutProperties AlignItemCaptionsInAllGroups="true">
            <Items>
                <dx:GridViewTabbedLayoutGroup ColSpan="1">
                    <Items>
                        <dx:GridViewLayoutGroup Caption="Thông tin loại sản phẩm" ColCount="2" ColSpan="1" ColumnCount="2">
                            <Items>
                                <dx:GridViewColumnLayoutItem ColSpan="1" ColumnName="Id">
                                </dx:GridViewColumnLayoutItem>
                                <dx:GridViewColumnLayoutItem ColSpan="1" ColumnName="Standards">
                                </dx:GridViewColumnLayoutItem>
                                <dx:GridViewColumnLayoutItem ColSpan="2" ColumnName="Name">
                                </dx:GridViewColumnLayoutItem>
                                <dx:GridViewColumnLayoutItem ColSpan="2" ColumnName="DisplayName" ColumnSpan="2">
                                </dx:GridViewColumnLayoutItem>
                                <dx:GridViewColumnLayoutItem ColSpan="1" ColumnName="Price">
                                </dx:GridViewColumnLayoutItem>
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="Name" Width="300px" VisibleIndex="2" ShowInCustomizationForm="True">
            </dx:GridViewDataTextColumn>
            ...
            <dx:GridViewDataTextColumn FieldName="DisplayName" Width="300px" VisibleIndex="3">
            </dx:GridViewDataTextColumn>

            <dx:GridViewDataTokenBoxColumn FieldName="Standards" VisibleIndex="4">
                <PropertiesTokenBox Tokens="" ClientInstanceName="tokenStandards"  AllowMouseWheel="True" DataSourceID="ObjectDataSourceStandard" TextField="Id" ValueField="Id" > 
    ...
    <asp:ObjectDataSource ID="GridViewDataSource" runat="server" DataObjectTypeName="Data.DataVMs.EquTypeVM"

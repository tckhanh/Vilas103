<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Pages/Root.master" CodeBehind="Scheduler.aspx.cs" Inherits="vilas103.SchedulerModule" Title="Scheduler" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <asp:ObjectDataSource ID="AppointmentDataSource" runat="server" DataObjectTypeName=" vilas103.Model.SchedulerAppointment"
        TypeName=" vilas103.Model.AppointmentDataSourceHelper"
    ...
    <asp:ObjectDataSource ID="ResourcesDataSource" runat="server" DataObjectTypeName=" vilas103.Model.SchedulerResource"
        TypeName=" vilas103.Model.ResourceDataSourceHelper"

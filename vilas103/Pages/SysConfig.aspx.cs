...
namespace vilas103
{
    public partial class SysConfig : System.Web.UI.Page
    {
        ...
        protected void GridView_EditFormLayoutCreated(object sender, ASPxGridViewEditFormLayoutEventArgs e)
        {
            ...
            //    if (dataColumn != null)
            //    {
            //        PropertyInfo MyPropertyInfo = typeof(SysConfigVM).GetProperty(dataColumn.FieldName);
        ...
        protected void GridView_CustomJSProperties(object sender, ASPxGridViewClientJSPropertiesEventArgs e)
        {
            ...
            //    e.Properties["cpAllCount"] = SysConfigProvider.Count(x => true);
            //    e.Properties["cpInActivedUnBlockedCount"] = SysConfigProvider.Count(x => x.Actived == false && x.Blocked == false);
            //    e.Properties["cpActivedBlockedCount"] = SysConfigProvider.Count(x => x.Actived == true && x.Blocked == true);
            //    e.Properties["cpInactivedBlockedCount"] = SysConfigProvider.Count(x => x.Actived == false && x.Blocked == true);
            //    e.Properties["cpActivedUnBlockedCount"] = SysConfigProvider.Count(x => x.Actived == true && x.Blocked == false);
            //    e.Properties["cpOwnerCount"] = SysConfigProvider.Count(x => x.UserName == User.Identity.Name);
            //}
        }

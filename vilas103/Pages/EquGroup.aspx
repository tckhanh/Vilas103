<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Pages/Root.master" CodeBehind="EquGroup.aspx.cs" Inherits="vilas103.EquGroup" Title="EquGroup" %>
...
<asp:Content runat="server" ContentPlaceHolderID="PageToolbar">
    <dx:ASPxMenu runat="server" ID="PageToolbar" ClientInstanceName="pageToolbar"
        ...
        <Items>
            <dx:MenuItem Enabled="false" Text="NHÓM CHỨC NĂNG SP">
        ...
        <EditFormLayoutProperties AlignItemCaptionsInAllGroups="true">
            <Items>
                <dx:GridViewTabbedLayoutGroup ColSpan="1">
                    <Items>
                        <dx:GridViewLayoutGroup Caption="Thông tin nhóm chức năng SP" ColCount="2" ColSpan="1" ColumnCount="2">
                            <Items>
...
<EditFormSettings Visible="False"></EditFormSettings>
    ...
    <asp:ObjectDataSource ID="GridViewDataSource" runat="server" DataObjectTypeName="Data.DataVMs.EquGroupVM"

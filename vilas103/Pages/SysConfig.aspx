<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Pages/Root.master" CodeBehind="SysConfig.aspx.cs" Inherits="vilas103.SysConfig" Title="SysConfig" %>
...
<asp:Content runat="server" ContentPlaceHolderID="PageToolbar">
    <dx:ASPxMenu runat="server" ID="PageToolbar" ClientInstanceName="pageToolbar"
        ...
        <Items>
            <dx:MenuItem Enabled="false" Text="THÔNG SỐ HỆ THỐNG">
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    <dx:ASPxGridView runat="server" ID="GridView" ClientInstanceName="gridView"
        ...
        <EditFormLayoutProperties AlignItemCaptionsInAllGroups="true">
            <Items>
                <dx:GridViewTabbedLayoutGroup ColSpan="1">
                    <Items>
                        <dx:GridViewLayoutGroup Caption="Thông tin thông số hệ thống" ColCount="2" ColSpan="1" ColumnCount="2">
                            <Items>
                                <dx:GridViewColumnLayoutItem ColSpan="1" ColumnName="Id">
                                </dx:GridViewColumnLayoutItem>
                                <dx:GridViewColumnLayoutItem ColSpan="1" ColumnName="ValueString">
                                </dx:GridViewColumnLayoutItem>
                                <dx:GridViewColumnLayoutItem ColSpan="1" ColumnName="ValueInt">
                                </dx:GridViewColumnLayoutItem>
                                <dx:GridViewColumnLayoutItem ColSpan="2" ColumnName="Description" ColumnSpan="2">
                                </dx:GridViewColumnLayoutItem>
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="Id" Width="100px" VisibleIndex="1" EditFormSettings-Visible="False" ShowInCustomizationForm="True">
                <EditFormSettings Visible="False"></EditFormSettings>
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="ValueString" Width="300px" VisibleIndex="2" ShowInCustomizationForm="True">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="CreatedBy" VisibleIndex="8" Visible="False" />
            <dx:GridViewDataDateColumn FieldName="CreatedDate" VisibleIndex="9" Visible="false" />
            <dx:GridViewDataTextColumn FieldName="UpdatedBy" VisibleIndex="10" Visible="false" />
            <dx:GridViewDataDateColumn FieldName="UpdatedDate" VisibleIndex="11" Visible="false" />
            <dx:GridViewDataCheckColumn FieldName="Actived" VisibleIndex="12" Visible="false">
            </dx:GridViewDataCheckColumn>
            <dx:GridViewDataCheckColumn FieldName="Blocked" VisibleIndex="13" Visible="false" />
            <dx:GridViewDataTextColumn FieldName="ValueInt" VisibleIndex="4">
                <PropertiesTextEdit DisplayFormatInEditMode="True" DisplayFormatString="{0:N0}">
                </PropertiesTextEdit>
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="Description" Width="300px" VisibleIndex="5">
            </dx:GridViewDataTextColumn>
        ...
        <ClientSideEvents BatchEditStartEditing="batchEditStartEditing" BeginCallback="beginCallback" Init="onGridViewInit" SelectionChanged="onGridViewSelectionChanged" ContextMenuItemClick="OnContextMenuItemClick" ContextMenu="OnContextMenu" EndCallback="endCallback" FocusedRowChanged="onGridViewFocusedRowChanged" />
    </dx:ASPxGridView>

    <asp:ObjectDataSource ID="GridViewDataSource" runat="server" DataObjectTypeName="Data.DataModels.SysConfigVM"
        TypeName="Data.Providers.SysConfigProvider"

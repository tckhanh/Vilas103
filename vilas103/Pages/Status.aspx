<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Pages/Root.master" CodeBehind="Status.aspx.cs" Inherits="vilas103.Status" Title="Status" %>
...
<asp:Content runat="server" ContentPlaceHolderID="PageToolbar">
    <dx:ASPxMenu runat="server" ID="PageToolbar" ClientInstanceName="pageToolbar"
        ...
        <Items>
            <dx:MenuItem Enabled="false" Text="TRẠNG THÁI HS">
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    <dx:ASPxGridView runat="server" ID="GridView" ClientInstanceName="gridView"
        ...
        <EditFormLayoutProperties AlignItemCaptionsInAllGroups="true">
            <Items>
                <dx:GridViewTabbedLayoutGroup ColSpan="1">
                    <Items>
                        <dx:GridViewLayoutGroup Caption="Thông tin trạng thái" ColCount="2" ColSpan="1" ColumnCount="2">
                            <Items>
                                <dx:GridViewColumnLayoutItem ColSpan="1" ColumnName="Id">
                                </dx:GridViewColumnLayoutItem>
                                <dx:GridViewColumnLayoutItem ColSpan="1" ColumnName="Name">
                                </dx:GridViewColumnLayoutItem>
                                <dx:GridViewColumnLayoutItem ColSpan="2" ColumnName="LinkedIds" ColumnSpan="2">
                                </dx:GridViewColumnLayoutItem>
                                <dx:GridViewColumnLayoutItem ColSpan="2" ColumnName="Group">
                                </dx:GridViewColumnLayoutItem>
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="Id" Width="150px" VisibleIndex="1" EditFormSettings-Visible="False" ShowInCustomizationForm="True">
<EditFormSettings Visible="False"></EditFormSettings>
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="Name" Width="200px" VisibleIndex="2" ShowInCustomizationForm="True">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="CreatedBy" VisibleIndex="5" Visible="False" />
            <dx:GridViewDataDateColumn FieldName="CreatedDate" VisibleIndex="6" Visible="false" />
            <dx:GridViewDataTextColumn FieldName="UpdatedBy" VisibleIndex="7" Visible="false" />
            <dx:GridViewDataDateColumn FieldName="UpdatedDate" VisibleIndex="8" Visible="false" />
            <dx:GridViewDataCheckColumn FieldName="Actived" VisibleIndex="9" Visible="false">
            </dx:GridViewDataCheckColumn>
            <dx:GridViewDataCheckColumn FieldName="Blocked" VisibleIndex="10" Visible="false" />
             
            <dx:GridViewDataTextColumn FieldName="Group" Width="300px" VisibleIndex="4">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTokenBoxColumn FieldName="LinkedIds" Width="300px" VisibleIndex="3">
                <PropertiesTokenBox AllowMouseWheel="True" Tokens="" DataSourceID="ObjectDataSourceStatus" TextField="Name" ValueField="Id">
                </PropertiesTokenBox>
    ...
    <asp:ObjectDataSource ID="GridViewDataSource" runat="server" DataObjectTypeName="Data.DataVMs.StatusVM"

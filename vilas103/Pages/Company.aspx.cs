...
namespace vilas103
{
    public partial class Company : BasePage
    {
        ...
        protected void GridView_EditFormLayoutCreated(object sender, ASPxGridViewEditFormLayoutEventArgs e)
        {
            ...
            if (layoutItemUserName == null) return;
        ...
        protected void GridView_CustomJSProperties(object sender, ASPxGridViewClientJSPropertiesEventArgs e)
        {
            ...
            //    e.Properties["cpAllCount"] = CompanyProvider.Count(x => true);
            //    e.Properties["cpInActivedUnBlockedCount"] = CompanyProvider.Count(x => x.Actived == false && x.Blocked == false);
            //    e.Properties["cpActivedBlockedCount"] = CompanyProvider.Count(x => x.Actived == true && x.Blocked == true);
            //    e.Properties["cpInactivedBlockedCount"] = CompanyProvider.Count(x => x.Actived == false && x.Blocked == true);
            //    e.Properties["cpActivedUnBlockedCount"] = CompanyProvider.Count(x => x.Actived == true && x.Blocked == false);
            //    e.Properties["cpOwnerCount"] = CompanyProvider.Count(x => x.UserName == User.Identity.Name);
            //}
        }

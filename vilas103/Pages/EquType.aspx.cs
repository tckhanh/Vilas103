...
namespace vilas103
{
    public partial class EquType : System.Web.UI.Page
    {
        ...
        protected void GridView_RowValidating(object sender, DevExpress.Web.Data.ASPxDataValidationEventArgs e)
        {
            ...
            if (GridView.IsNewRowEditing)
            {
                ...
                foreach (GridViewColumn column in GridView.Columns)
                {
                    ...
                    PropertyInfo myFieldInfo = typeof(EquTypeVM).GetProperty(dataColumn.FieldName);
                    if (myFieldInfo == null) continue;
        ...
        protected void GridView_EditFormLayoutCreated(object sender, ASPxGridViewEditFormLayoutEventArgs e)
        {
            ...
            //    if (dataColumn != null)
            //    {
            //        PropertyInfo MyPropertyInfo = typeof(EquTypeVM).GetProperty(dataColumn.FieldName);
        ...
        protected void GridView_CustomJSProperties(object sender, ASPxGridViewClientJSPropertiesEventArgs e)
        {
            ...
            //    e.Properties["cpAllCount"] = EquTypeProvider.Count(x => true);
            //    e.Properties["cpInActivedUnBlockedCount"] = EquTypeProvider.Count(x => x.Actived == false && x.Blocked == false);
            //    e.Properties["cpActivedBlockedCount"] = EquTypeProvider.Count(x => x.Actived == true && x.Blocked == true);
            //    e.Properties["cpInactivedBlockedCount"] = EquTypeProvider.Count(x => x.Actived == false && x.Blocked == true);
            //    e.Properties["cpActivedUnBlockedCount"] = EquTypeProvider.Count(x => x.Actived == true && x.Blocked == false);
            //    e.Properties["cpOwnerCount"] = EquTypeProvider.Count(x => x.UserName == User.Identity.Name);
            //}
        }
        ...
        protected void ASPxTokenBoxStandards_Callback(object sender, CallbackEventArgsBase e)
        {
